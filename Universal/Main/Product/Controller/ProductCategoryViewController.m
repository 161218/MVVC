...
@interface ProductCategoryViewController ()<UIWebViewDelegate,UINavigationControllerDelegate>
...
-(void)loadWebRequest
{
    ...
    if (oauthToken == nil) {
        ...
        [post setObject:@"productList" forKey:@"service"];
        ...
        self.URLString = [NSString stringWithFormat:@"%@?&service=%@&appId=%@&signType=%@&sign=%@",APP_INVESTMENTLIST,@"productList",APP_ID,SIGN_TYPE,paramsStr];
    ...
    else
    {
        ...
        self.URLString = [NSString stringWithFormat:@"%@?oauthToken=%@&service=%@&appId=%@&signType=%@&sign=%@",APP_INVESTMENTLIST,oauthToken,@"productList",APP_ID,SIGN_TYPE,paramsStr];
